...
export interface OptqSchema extends DBSchema {
  requests: {
    ...
    value: {
      ...
      params: unknown;
      headers: unknown;
      body: unknown; // serialized by SuperJSON
      respondedAt?: string;
  ...
  caches: {
    ...
    value: {
      resId: string;
      hash: string;
      value: unknown; // serialized by SuperJSON
      respondedAt: string;
    };
...
export interface OptqDatabase {
  getMetadata(): Promise<{ version: number; apiVersion?: number }>;
  setMetadata(metadata: { version: number; apiVersion?: number }): void | Promise<void>;
  ...
  deleteRequest(request: { id: string }): void | Promise<void>;
  deleteCache(cache: {
    resId: string;
    hash: string;
  }): void | Promise<void>;
